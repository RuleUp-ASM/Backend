package com.ruleup.ruleup_backend.push.service;

import com.ruleup.ruleup_backend.push.DisplayPush;
 ...
 * 끝까지 돌려볼 수 있도록 전송 자리를 이 로깅 어댑터로 채운다. Firebase Admin 자격증명이 준비돼
 * {@code FcmPushSender}(실제 {@code PushSender} 구현)를 추가할 땐 그 빈에 {@code @Primary} 를 붙이면
 * 이 로깅 빈 대신 그쪽이 주입된다.
 */
@Component
