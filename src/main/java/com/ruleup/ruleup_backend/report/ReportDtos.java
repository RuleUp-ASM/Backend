...
public final class ReportDtos {
    ...
    public record CreateRequest(
            ...
            @Schema(description = "신고 사유", example = "ABUSE",
                    allowableValues = {"SPAM", "ABUSE", "HATE", "SEXUAL", "VIOLENCE", "OTHER"},
                    requiredMode = Schema.RequiredMode.REQUIRED)
            String reason,

            @Schema(description = "상세 내용(최대 1000자). reason=OTHER 면 필수이고, 그 외에도 적어 보내는 것을 권장한다.",
    ...
    public record UserItem(String userId, String nickname, String profileImageUrl,
                           @Schema(example = "2026-08-17T10:00:00Z") String blockedAt) {}

    @Schema(name = "BlacklistChallengeItem", description = "차단한 챌린지 — 탐색 목록에서 빠진다")
    public record ChallengeItem(String challengeId, String title,
                                @Schema(example = "2026-08-17T10:00:00Z") String blockedAt) {}
