...
-- 변경점:
--   · has_auto / default_method STORED 생성컬럼 제거 → 비즈니스 로직에서 계산(autoVerificationType 기준)
--   · 2차 인덱스(category/has_auto) 제거 → 카디널리티 학습 후 추가
...
-- ===== 시드: RoutineTemplate 105개 =====
INSERT INTO RoutineTemplate
(name, description, category,
 autoVerificationType, autoSignalSource, autoWearableReq,
 autoExternalService, autoRequiredPermissions,
 manualSignalSource, paramSchema, rationale)
VALUES
-- EXERCISE (1-7)
